...
export const faceAreas: FaceArea[] = [
  {
    ...
    focus: { x: 50, y: 47 },
    hotspot: { left: 45.5, top: 35, width: 9, height: 25 },
  },
  {
    id: "lips",
    label: "الشفاه",
    ...
    focus: { x: 50, y: 65 },
    hotspot: { left: 39.5, top: 60, width: 21, height: 10 },
  },
  {
    id: "cheeks",
    label: "الخدود",
    ...
    focus: { x: 50, y: 53 },
    hotspot: { left: 24, top: 42, width: 52, height: 23 },
  },
  {
    id: "jawline",
    label: "الفك",
    ...
    focus: { x: 50, y: 76 },
    hotspot: { left: 28, top: 64, width: 44, height: 22 },
  },
  {
    id: "chin",
    label: "الذقن",
    ...
    focus: { x: 50, y: 77 },
    hotspot: { left: 42, top: 71, width: 16, height: 12 },
  },
  {
    id: "forehead",
    label: "الجبهة",
    ...
    focus: { x: 50, y: 17 },
    hotspot: { left: 35, top: 9, width: 30, height: 18 },
  },
  {
    id: "underEyes",
    label: "تحت العين",
    ...
    focus: { x: 50, y: 38 },
    hotspot: { left: 31, top: 33, width: 38, height: 10 },
  },
  {
    id: "eyebrows",
    label: "الحواجب",
    ...
    focus: { x: 50, y: 27 },
    hotspot: { left: 29, top: 22, width: 42, height: 10 },
  },
  {
    id: "skin",
    label: "نضارة الوجه",
    ...
    focus: { x: 50, y: 48 },
    hotspot: { left: 25, top: 8, width: 50, height: 80 },
  },
];
